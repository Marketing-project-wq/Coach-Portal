  ...
  + '<div style="margin-bottom:22px;">'
    + '<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:6px;">'
      ...
      + '<div style="display:flex;gap:9px;align-items:center;flex-wrap:wrap;">'
        ...
        + '<sc-if value="{{ hasRegister }}"><button onclick="{{ exportAttendance }}" style="background:var(--volt);border:0;color:#fff;border-radius:10px;padding:9px 15px;font-family:\'Archivo\';font-weight:800;font-size:12.5px;cursor:pointer;">&#128196; Cetak PDF</button></sc-if>'
      + '</div>'
    + '</div>'
...
// "Panduan" — opens the coach guide (Internal or Freelance) in a new tab. Helps new coaches learn the workspace.
const guideNav = '<sc-if value="{{ showGuide }}"><button onclick="{{ goGuide }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;border:0;cursor:pointer;background:var(--volt-dim);color:var(--volt);font-family:\'Hanken Grotesk\';font-weight:700;font-size:14px;text-align:left;border-left:3px solid var(--volt);transition:background .15s;" style-hover="background:rgba(228,0,43,.16);">&#128214; Panduan</button></sc-if>';
template = template.replace(/(<button onclick="\{\{ goDash \}\}"[\s\S]*?<\/button>)/, '$1' + guideNav);
