...
const venueCard = '<div style="' + cardBox + 'padding:16px 18px;">'
  ...
  + '</div>'
  + '<sc-if value="{{ b.canSetCoach }}"><div style="margin-top:13px;padding-top:13px;border-top:1px solid var(--border);display:flex;align-items:center;gap:10px;flex-wrap:wrap;">'
