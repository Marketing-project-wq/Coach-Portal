...
window.__I18N = (function () {
  ...
  var T = {
    ...
    // Gym scan member / visit history
    scan_hint:             { id: 'Scan barcode member atau ketik kode voucher, lalu Enter', en: 'Scan the member barcode or type the voucher code, then Enter' },
    scan_placeholder:      { id: 'Scan / ketik kode…',        en: 'Scan / type code…' },
    search_member:         { id: 'Cari nama member',          en: 'Search member name' },
    confirm_checkin:       { id: 'Konfirmasi & Potong Sesi',  en: 'Confirm & Deduct Session' },
    sessions_used:         { id: 'Sesi terpakai',             en: 'Sessions used' },
    sessions_left:         { id: 'Sisa sesi',                 en: 'Sessions left' },
    checkin_recorded:      { id: 'Kunjungan tercatat',        en: 'Visit recorded' },
    cancel_checkin:        { id: 'Batalkan',                  en: 'Cancel' },
    checkin_cancelled:     { id: 'Kunjungan dibatalkan, sesi dikembalikan', en: 'Visit cancelled, session refunded' },
    quota_exhausted_warn:  { id: 'Kuota habis. Isi alasan untuk tetap mencatat (melebihi kuota).', en: 'Quota exhausted. Enter a reason to record anyway (over quota).' },
    expired_warn:          { id: 'Paket kadaluarsa. Isi alasan untuk tetap mencatat.', en: 'Package expired. Enter a reason to record anyway.' },
    record_anyway:         { id: 'Tetap Catat',               en: 'Record Anyway' },
    already_checked_in:    { id: 'Member sudah check-in dalam 1 jam terakhir', en: 'Member already checked in within the last hour' },
    unknown_barcode:       { id: 'Barcode tidak dikenali. Coba cari manual.', en: 'Barcode not recognised. Try manual search.' },
    over_quota_tag:        { id: 'Melebihi kuota',            en: 'Over quota' },
    cancelled_tag:         { id: 'Dibatalkan',                en: 'Cancelled' },
    check_in_coach:        { id: 'Check In',                  en: 'Check In' },
    checked_in:            { id: 'Sudah Check-in',            en: 'Checked in' },
    todays_pt_sessions:    { id: 'Sesi PT Hari Ini',          en: "Today's PT Sessions" },
    ...
    // Gym members tabs & filters
    all_clients:           { id: 'Semua Klien',                en: 'All Clients' },
    active_30d:            { id: 'Aktif (30 Hari)',            en: 'Active (30 Days)' },
    active_package:        { id: 'Paket Aktif',                en: 'Active Package' },
    inactive_clients:      { id: 'Non-Aktif',                  en: 'Inactive' },
    search_name_phone:     { id: 'Cari nama atau nomor telepon…', en: 'Search name or phone…' },
    showing_x_of_y:        { id: 'Menampilkan',                en: 'Showing' },
    of_total:              { id: 'dari',                       en: 'of' },
    clients_label:         { id: 'klien',                      en: 'clients' },
    pkg_active:            { id: 'Aktif',                      en: 'Active' },
    pkg_used_up:           { id: 'Habis',                      en: 'Used up' },
    pkg_expired:           { id: 'Expired',                    en: 'Expired' },
    pkg_status:            { id: 'Status Paket',               en: 'Package Status' },
    member_detail:         { id: 'Detail Member',              en: 'Member Detail' },
    packages_label:        { id: 'Paket',                      en: 'Packages' },
    recent_visits:         { id: 'Kunjungan Terakhir',         en: 'Recent Visits' },
    no_packages_yet:       { id: 'Belum ada paket',            en: 'No packages yet' },
    no_visits_yet:         { id: 'Belum ada kunjungan',        en: 'No visits yet' },
    gym_clients:           { id: 'Klien Gym',                  en: 'Gym Clients' },
    active_30d_short:      { id: 'aktif 30 hari',             en: 'active 30 days' },
    col_name:              { id: 'Nama',                      en: 'Name' },
    col_phone:             { id: 'Telp',                      en: 'Phone' },
    col_visits:            { id: 'Kunjungan',                 en: 'Visits' },
    col_last_visit:        { id: 'Terakhir',                  en: 'Last Visit' },
